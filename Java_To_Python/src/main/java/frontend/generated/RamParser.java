...
{if ("" != null) return new Program(m, cl);}
  ...
  final public MainClass MainClass() throws ParseException {Identifier i1, i2;
    Statement s;
...
*/
  final public 
ClassDecl ClassDecl() throws ParseException {Identifier i;
...
i2 = new Identifier(token.image);
      ...
      jj_consume_token(RPAREN);
      s1 = Statement();
{if ("" != null) return new For(i, i2, e1, e2, e3, s1);}
      break;
      }
    case PRINT:{
  ...
  private boolean jj_3R_28()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x2000,0x20000,0x0,0x0,0x2000,0x2000,0x0,0x300000,0x200000,0x3c00000,0x3800000,0x30000000,0x20000000,0x0,0x40800,0x800,0x40000,0x0,0x200,0x20000,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x8,0x800204,0x2000,0x9801c0,0x0,0x800204,0x800204,0x9801c0,0x1801c0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0xc60020,0x1000,0x0,0xc61022,};
   }
